...
// adding several recipes

Recipes.create('hot chocolate', ['milk', 'cocoa', 'cream']);
Recipes.create('smoothie', ['water', 'frozen fruits', 'cocoa']);
Recipes.create('soup', ['water', 'meat', 'vegetables']);
